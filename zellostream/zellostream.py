...
def get_config():
	...
	config["vox_silence_time"] = configdata.get("vox_silence_time", 10)
	config["audio_threshold"] = configdata.get("audio_threshold", 50)
	...
	config["audio_source"] = configdata.get("audio_source","UDP")
